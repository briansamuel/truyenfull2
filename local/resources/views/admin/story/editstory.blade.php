                  ...
                  <div class="box box-info">
                    ...
                    <div class="box-body pad">
                      <div class="form-group">
                        <input name="story_title" class="form-control input-lg" type="text" placeholder="Tiêu đề bài viết" value="{{$story->story_title}}">
                      </div>
                      <div class="form-group">
                        <textarea name="story_excerpt" class="form-control" rows="3" placeholder="Mô tả">{{$story->story_excerpt}}</textarea>
                      </div>
                      ...
                      <div class="input-group">
                        ...
                        <!-- /btn-group -->
                        <input name="story_keyword" type="text" class="form-control" value="{{$story->story_keyword}}">
                      </div>
                    </div>
                    <div class="box-footer">
                      <button type="submit" class="btn btn-default">Cancel</button>
                      <button type="submit" class="btn btn-info pull-right">Cập nhật truyện</button>
                    </div>
                  </div>
